...
public class DownloaderVideoController(
    ILogger<DownloaderVideoController> _logger,
    IDownloaderVideoAppServices _generateTemplateAppService,
    INotificationBase notificationBase
    ) : BaseController(notificationBase)
{
    /// <summary>
